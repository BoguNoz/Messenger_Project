...
namespace Messager_Project.Repository.Messages
{
    ...
    {
        public MSMessagesRepository(DbContext dbContext) : base(dbContext)
        {
        }
        ...
        public async Task<ResponseModel<Message>> SaveRelationAsync(Message relation)
        {
            ...
            return new ResponseModel<Message> { Status = true, Message = "MessageRepositories saved successfully", ReferenceObject = relation };
        }
        ...
        public async Task<ResponseModel<Message>> DeleteRelationAsync(int id)
        {
            ...
            if (relation == null)
                return new ResponseModel<Message> { Status = true, Message = "MessageRepositories deleted successfully", ReferenceObject = relation };
