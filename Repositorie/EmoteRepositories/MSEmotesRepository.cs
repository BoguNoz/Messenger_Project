...
namespace Messager_Project.Repository.Emote
{
    public class MSEmotesRepository : BaseRepository, IEmotesRepository
    {
        ...
        public MSEmotesRepository(DbContext dbContext) : base(dbContext)
        {
        }
        ...
        {
            if(emote == null)
                return new ResponseModel<Emotes> { Status = false, Message = "EmoteRepositories is null", ReferenceObject = null };

            if(DbContext._emotes.Any(e => e.Emote_Name.Equals(emote.Emote_Name)))
                return new ResponseModel<Emotes> { Status = false, Message = "EmoteRepositories name arledy exist in data base", ReferenceObject = emote }; 
            ...
            return new ResponseModel<Emotes> { Status = true, Message = "EmoteRepositories saved successfully", ReferenceObject = emote };
        }
        ...
        public async Task<ResponseModel<Emotes>> DeleteEmoteAsync(int id)
        {
            ...
            if (emote == null)
                return new ResponseModel<Emotes> { Status = true, Message = "EmoteRepositories delete successfully", ReferenceObject = null };
            ...
            return new ResponseModel<Emotes> { Status = true, Message = "EmoteRepositories delete successfully", ReferenceObject = emote };
        }
